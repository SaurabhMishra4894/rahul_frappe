...
frappe.ui.form.on('Tenant Bill Overview', {
	previous_electrical_unit: function(frm) {
		...
		frm.set_value("total_rent", frm.doc.previous_dues + frm.doc.base_rent +
			(frm.doc.unit_consumed * frm.doc.charge_per_unit)
			+ frm.doc.misc_charges + frm.doc.gas_charges + frm.doc.water_charges + frm.doc.electricity_charges)
